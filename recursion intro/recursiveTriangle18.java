   ...
   public void Triangle(int[] xPos, int[] yPos, Graphics page)
   {
       ...
       if (distance<300)
        ...
        //
            ...
            int [] x1 = {xPos[0], (xPos[1]+xPos[2])/2, (xPos[2]+xPos[3])/2, xPos[0]};
            int [] y1 = {yPos[0], (yPos[1]+yPos[2])/2, (yPos[2]+yPos[3])/2, yPos[0]};
            
            int [] x2 = {(xPos[0]+xPos[1])/2, xPos[1], (xPos[2]+xPos[3])/2,(xPos[0]+xPos[1])/2};
            int [] y2 = {(yPos[0]+yPos[1])/2, yPos[1], (yPos[2]+yPos[3])/2,(yPos[0]+yPos[1])/2};
            
            int [] x3 = {(xPos[0]+xPos[1])/2, (xPos[1]+xPos[2])/2, xPos[2],(xPos[0]+xPos[1])/2};
            int [] y3 = {(yPos[0]+yPos[1])/2, (yPos[1]+yPos[2])/2, yPos[2],(yPos[0]+yPos[1])/2};
